...
#define SHADER_SUB_DIR_NAME std::string("solution2")
#define SHADER_SUB_DIR_NAME_W std::wstring(L"solution2")
...
public:
	...
	{
		title = "VulkanRT Educational Solution2";
...
#ifdef _WIN32
		SpirvCompiler compiler(std::wstring(PROJECTDIR_SOLUTION2_W) + L"shaders/", getShadersPathW() + SHADER_SUB_DIR_NAME_W + L"/");
#else
		SpirvCompiler compiler(std::string(PROJECTDIR_SOLUTION2) + "shaders/", getShadersPath() + SHADER_SUB_DIR_NAME + "/");
#endif
		compiler.CompileAll();
	}
