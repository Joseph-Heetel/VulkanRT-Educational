...
* 
* Small change by Joseph Heetel: Add empty constructor to pass on validation toggle to base class constructor
*/
...
public:
	...
	inline VulkanRaytracingSample(bool enableValidation = false) : VulkanExampleBase(enableValidation) {}
